...
CUSTOM_APPS: list[str] = ["apps.user", "apps.courses", "apps.exams", "apps.questions", "apps.community"]
...
VERIFYCATION_DEFAULT_TTL_SECONDS = int(os.getenv("VERIFYCATION_DEFAULT_TTL_SECONDS","300"))
VERIFYCATION_TOKEN_GENERATE_MAX_ATTEMPTS = int(os.getenv("VERIFYCATION_TOKEN_GENERATE_MAX_ATTEMPTS","5"))
VERIFYCATION_CODE_LENGTH = int(os.getenv("VERIFYCATION_CODE_LENGTH","6"))
VERIFYCATION_TOKEN_BYTES = int(os.getenv("VERIFYCATION_TOKEN_BYTES","32"))
VERIFYCATION_CODE_CHARS = os.getenv("VERIFYCATION_CODE_CHARS",default="1234567890")
