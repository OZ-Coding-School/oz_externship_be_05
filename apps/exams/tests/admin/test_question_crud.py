...
class ExamAdminQuestionViewTest(APITestCase):
    ...
    def test_create_question_explanation_null_success(self) -> None:
    ...
    def test_create_question_missing_explanation_fails(self) -> None:
        """explanation 키 누락 시 errors 내부에 키가 있는지 확인"""
        data = {
            "type": "ox",
            "question": "키 누락 테스트",
            "correct_answer": ["O"],
        ...
        # 공통 응답 규격인 errors 내부 확인
        self.assertIn("explanation", response.data.get("errors", {}))
